...
def load_file(filename):
    ...
    with open(filename, 'r') as f:
        for line in f:
            timestamp, value = parse_sbe45_line(line)
...
def main():
    ...
    print("Loading SBE45 data files...")

    try:
        ref_times, ref_values = load_file(dslog_sbe45_stream)
        target_times, target_values = load_file(openrvdas_sbe45_stream)
